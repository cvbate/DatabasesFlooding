...
The data included in this repository is: 

1. Katrina Flood Extent (TIF)
2. Permanent Water in Louisiana (TIF)
3. Katrina Flood Extent not including Permanent Water (TIF)
4. Katrina Duration of Flooding (TIF)
5. Levee Stations Louisiana (SHP)
6. Boreholes Louisiana (SHP)
7. Floodwalls Louisiana (SHP)
